...
public class FiltersActivity extends AppCompatActivity {
    ...
    private void init(){
        //saved all the preferences of the user
        getFilterPreferences();

        //we need to attack an onClickListener to the SAVE button
        //and save the new preferences if the user has changed anything
